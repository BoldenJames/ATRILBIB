...
def get_metadata_from_pdf_url(pdf_url):
    ...
    if response.status_code == 200:
        ...
        # Puedes procesar el texto del PDF para extraer información adicional según tus necesidades
        # Aquí simplemente devolvemos el texto completo como metadata
...
def main(urle):
    ...
    # Verifica si la URL apunta a un PDF
